...
namespace Legendary_Rune_Maker.Game
{
	public static class GameState
	{
		...
		public static bool CanUpload => State.CurrentState != GameStates.Disconnected && State.CurrentState != GameStates.NotLoggedIn && State.CurrentState != GameStates.Disallowed;
