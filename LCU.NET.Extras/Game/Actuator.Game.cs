    ...
    public partial class Actuator
    {
        ...
        public async Task UploadRunes(Position pos, int championId)
        {
            ...
            if (page == null)
            {
                ...
                Main.ShowNotification($"No runes for position {positionName}", $"There's not enough info to set runes for your selected champion in position {positionName}", NotificationType.Error);
                return;
            }
            ...
            Main.TrackInjection(InjectionType.Runes);
        }
        ...
        public async Task UploadSpells(Position pos, int championId)
        {
            ...
            if (provider.Supports(Provider.Options.Spells))
            {
                ...
                Main.TrackInjection(InjectionType.Spells);
            }
        }
